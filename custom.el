...
(setq centaur-full-name "chenzhiyuan")           ; User full name
(setq centaur-mail-address "czy463@163.com")   ; Email address
...
;; (setq centaur-lsp-format-on-save-ignore-modes '(go-mode)) ; Ignore format on save for some languages
